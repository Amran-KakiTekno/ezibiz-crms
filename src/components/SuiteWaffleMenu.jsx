...
export default function SuiteWaffleMenu({ currentApp = 'crms' }) {
  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      <button
        ...
        className={`min-w-[40px] min-h-[40px] flex items-center justify-center p-2 rounded-xl transition-all cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 ${
          isOpen 
            ...
            {APPS.map(app => {
              ...
              return (
                ...
                >
                  ...
                  {isCurrent ? (
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-500/20 font-medium shrink-0 flex items-center gap-1">
