      ...
      <div>
        <div className="flex border-b border-slate-200 dark:border-slate-800 text-xs mb-3">
          <button
            ...
            className={`flex-1 pb-2 font-medium border-b-2 text-center transition-colors cursor-pointer min-h-[44px] flex items-center justify-center ${
              sidebarTab === 'ai_scope'
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-1.5">
                <input 
                  ...
                  className="flex-1 bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded px-3 py-2 text-base sm:text-xs min-h-[44px] sm:min-h-0 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-600 focus:outline-none focus:border-indigo-500"
                />
                <button 
                  onClick={handleNoteSubmit}
                  className="px-3 py-2 rounded-lg bg-indigo-50 dark:bg-indigo-600/30 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/30 text-xs font-medium hover:bg-indigo-600 hover:text-white transition-all cursor-pointer min-h-[44px] min-w-[44px] flex items-center justify-center"
                >
                  Add
                </button>
              </div>
