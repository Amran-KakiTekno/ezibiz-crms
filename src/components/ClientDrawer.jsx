...
export default function ClientDrawer({
  ...
  return (
    <div className="p-4 bg-slate-900 flex flex-col justify-between space-y-4 h-full">
      {/* Drawer Tabs */}
      <div>
          ...
          <div className="space-y-3 animate-in fade-in">
            ...
            <div className="space-y-2 pt-2">
              <button
                ...
                className="w-full py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold flex items-center justify-center gap-1.5 shadow-lg shadow-indigo-600/20 transition-all hover:scale-[1.01] active:scale-[0.99]"
              >
